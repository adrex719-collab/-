...
export default defineSchema({
  ...
  permits: defineTable({
    ...
    authorizationApproved: v.boolean(), riskReviewed: v.boolean(), eligibilityVerified: v.boolean(), requiresLoto: v.boolean(), lotoApplied: v.boolean(), lotoReleased: v.boolean(),
